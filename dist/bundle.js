...
var buttonElement = document.getElementById("convertButton");
var selectElement = document.getElementById("selectField");
buttonElement.addEventListener("click", convertString);
function convertString() {
    var inputString = inputElement.value;
    var outputField = document.getElementById("resultField");
    if (selectElement.value == "ToUpperCase") {
        outputField.innerHTML = "Result: " + inputString.toUpperCase();
    }
    else
        outputField.innerHTML = "Result: " + inputString.toLowerCase();
}
